...
import com.hw.sentiment.dto.topiccommunicatepath.Message;
import com.hw.sentiment.dto.topiccommunicatepath.MessageContent;
 ...
 * @author ymy
 * @date 2019/12/28
 * @description  舆情话题传播路径信息请求和应答
 */
@Api(tags = "PubOpinionTopicCommunicationPathController",description = "舆情话题传播路径信息请求和应答")
@RestController
@RequestMapping("/path")
public class TopicCommunicatePathController {

    @ApiOperation("传播路径信息请求")
    @PostMapping("/info")
    @ResponseBody
    public Message Find(@RequestBody String param ){
        ...
        File file = new File("f:\\testfile\\11.xml");
